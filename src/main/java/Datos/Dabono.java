...
public class Dabono {
    ...
    public int getColchonadi() {
        return colchonadi;
    }

    public void setColchonadi(int colchonadi) {
        this.colchonadi = colchonadi;
    }
